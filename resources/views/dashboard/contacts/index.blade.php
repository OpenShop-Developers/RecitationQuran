            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" style="page-break-inside: avoid">
                    ...
                    <tr>
                        <td>#</td>
                        <td>الرساله</td>
                        <td>الرساله مرسله من العضو</td>
                        <td>الرساله مرسله الي المحفظ</td>
                        <td>الردود علي الرساله (اذا وجدت)</td>
                        <td class="text-center">رد علي الرساله</td>
                    ...
                    @foreach($records as $record)
                        <tr>
                            ...
                            <td>
                                ...
                                @if($record->type == 2)
                                    <audio controls>
                                        <source src="{{asset('uploads/audio/'. $record->message)}}">
                                    </audio>
                                @else
                                    {{$record->message}}
                                @endif
                            ...
                            <td>
                                <a href="{{route('clients.edit', $record->client->id)}}">
                                    {{$record->client->name}}
                                </a>
                            </td>
                            <td>
                                @if($record->user_id == auth()->user()->id)
                                    الرساله موجهه لك
                                @else
                                <a href="{{route('users.edit', $record->user->id)}}">

                                        {{$record->user->name}}
                                </a>
                                @endif
                            </td>
                            <td>{{$record->adminReply}}</td>
                            <td class="text-center">
                                <a href="{{url(route('contacts.edit' ,$record->id))}}"
                            ...
                            <td class="text-center">
                                ...
                                {!! Form::open([
                                    'action' => ['Dashboard\ContactController@destroy' , $record->id],
                                    'method' => 'delete'
                                ]) !!}
